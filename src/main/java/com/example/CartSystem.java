    ...
    public void display() {
        ...
        while (iCIterator.hasNext()) {
            ...
            if (itemCollection.get(mapElement.getKey()).getQuantity() > 0) {
                ...
                System.out.printf( "%-20s %-20s %-10s %-10d %10s\n", itemCollection.get(mapElement.getKey()).getItemName(), itemCollection.get(mapElement.getKey()).getItemDesc(), itemCollection.get(mapElement.getKey()).getItemPrice(), itemCollection.get(mapElement.getKey()).getQuantity(), itemSubtotal );
